...
class Heart extends Shape {
    render() {
        return `<svg width="100" height="100" viewBox="0 0 32 29.6"><path d="M23.6,2.9c-2.9,0-5.5,1.5-7,3.8C15.1,4.4,12.5,2.9,9.6,2.9C4.3,2.9,0,7.2,0,12.5c0,3.4,1.7,7.1,5,10.4L16,29.6l11-6.7c3.3-3.3,5-7,5-10.4C32,7.2,27.7,2.9,23.6,2.9z" fill="${this.color}"/></svg>`;
    }
}
